...
//!
//! Split from [`crate::live`] so the portable half of the harness - WAV
//! analysis, the bench, swept measurement - compiles on Linux and Windows,
//! where this module does not exist at all.
//!
